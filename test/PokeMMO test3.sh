...
$ESUDO env CRUSTY_SHOW_CURSOR=1 SDL_NO_SIGNAL_HANDLERS=1 WRAPPED_LIBRARY_PATH="$GAMEDIR/libs:$LD_LIBRARY_PATH" WESTON_HEADLESS_WIDTH="$DISPLAY_WIDTH" WESTON_HEADLESS_HEIGHT="$DISPLAY_HEIGHT" $weston_dir/westonwrap.sh drm auto kiosk llvmpipe \
